/**
 * Mirror of `packages/shared/messaging/topology.ts`. Both backend and
 * email-service MUST declare identical exchange/queue/binding shapes,
 * so the helper lives once per app and is byte-for-byte the same.
 *
